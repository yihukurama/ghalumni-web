...
@Form.create()
export default class CommList extends PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    const {listTitle, adminBaseCrud: {data, total}, loading, searchCondition, createConditon} = this.props;
